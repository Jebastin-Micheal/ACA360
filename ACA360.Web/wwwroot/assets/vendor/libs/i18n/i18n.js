        ...
        return function () {
            ...
            class O extends S {
                ...
                addResourceBundle(e, t, o, n, s) {
                    ...
                    let a = u(this.data, r) || {};
                    i.skipCopy || (o = JSON.parse(JSON.stringify(o))), n ? h(a, o, s) : a = {
                        ...a,
                        ...o
            ...
            class P extends S {
                ...
                translate(t, o, n) {
                    if ("object" != typeof o && this.options.overloadTranslationOptionHandler && (o = this.options.overloadTranslationOptionHandler(arguments)), "object" == typeof o && (o = {
                        ...o
                    }), o || (o = {}), null == t) return "";
                ...
                getUsedParamsDetails() {
                    ...
                    let s = n ? t.replace : t;
                    if (n && void 0 !== t.count && (s.count = t.count), this.options.interpolation.defaultVariables && (s = {
                        ...this.options.interpolation.defaultVariables,
                        ...s
                    }), !n) {
                        s = {
            ...
            class D {
                ...
                nest(t, n) {
                    ...
                    for (; s = this.nestingRegexp.exec(t);) {
                        ...
                        e(i) || (i = o(i)), i || (this.logger.warn(`missed to resolve ${s[1]} for nesting ${t}`), i = ""), u && (i = c.reduce(((e, t) => this.format(e, t, a.lng, {
                            ...a,
