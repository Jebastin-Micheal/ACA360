! function (t, e) {
    ...
    return function () {
        ...
        return function () {
            ...
            var y, _ = ["color", "theme", "skins", "semiDark", "contentLayout", "headerType", "layoutCollapsed", "layoutNavbarOptions", "rtl", "layoutFooterFixed", "showDropdownOnHover", "navigationLike", "sidenavHeader"],
                k = ["light", "dark", "system"],
                ...
                D = function () {
                    function t(e) {
                        ...
                        if (function (t, e) {
                            ...
                            if (this.settings = {}, this.settings.displayCustomizer = void 0 === o || o, this.settings.lang = i || "en", n ? (this.settings.defaultPrimaryColor = n, z = !0) : (this.settings.defaultPrimaryColor = O.getPropertyValue("--bs-primary").trim(), z = !1), this.settings.defaultTheme = s || w, this.settings.defaultSemiDark = void 0 !== r ? r : !0, this.settings.defaultContentLayout = void 0 !== l ? l : "wide", this.settings.defaultHeaderType = c || "fixed", this.settings.defaultMenuCollapsed = void 0 !== u ? u : L, this.settings.defaultNavbarType = void 0 !== d ? d : E, this.settings.defaultTextDir = "rtl" === m || N, this.settings.defaultFooterFixed = void 0 !== p ? p : T, this.settings.defaultShowDropdownOnHover = void 0 === h || h, this.settings.defaultNavigationLike = e.defaultNavigationLike || "topnav", this.settings.availableNavigationLike = e.availableNavigationLike || t.NAVIGATION_TYPES, this.settings.defaultSidenavHeader = e.defaultSidenavHeader || "static", this.settings.availableSidenavHeader = e.availableSidenavHeader || t.SIDENAV_HEADER_TYPES, this.settings.controls = g || _, this.settings.availableColors = b || t.COLORS, this.settings.availableSkins = f || t.SKINS, this.settings.availableThemes = y || t.THEMES, this.settings.availableContentLayouts = S || t.CONTENT, this.settings.availableHeaderTypes = D || t.HEADER_TYPES, this.settings.availableMenuCollapsed = q || t.LAYOUTS, this.settings.availableNavbarOptions = H || t.NAVBAR_OPTIONS, this.settings.availableDirections = I || t.DIRECTIONS, this.settings.defaultSkin = this._getDefaultSkin(void 0 !== a ? a : C), this.settings.themes = v || k, this.settings.themes.length < 2) {
                    ...
                    return e = t, o = [{
                        ...
                        value: function (t) {
                            ...
                            if (this._hasControls("headerType") && ["static", "static-offcanvas", "fixed", "fixed-offcanvas"].includes(t)) {
                                ...
                                if (e) this._setSetting("HeaderType", t);
                                window.Helpers.setPosition("fixed" === t || "fixed-offcanvas" === t, "static-offcanvas" === t || "fixed-offcanvas" === t);
                                if (e) this.settings.onSettingsChange.call(this, this.settings);
                                var o = window.Helpers.menuPsScroll,
                                    i = window.PerfectScrollbar;
                                if ("fixed" === this.settings.headerType || "fixed-offcanvas" === this.settings.headerType) {
                                    if (i && o) {
                        ...
                        value: function () {
                            if (!this._ssr) {
                                const layout = this._getLayoutName();
                                const keepHeader = localStorage.getItem(`templateCustomizer-${layout}--HeaderType`);
                                const keys = ["Color", "Theme", "Skin", "SemiDark", "LayoutCollapsed", "FixedNavbarOption", "HeaderType", "contentLayout", "Rtl", "Lang"];
                                keys.forEach(k => localStorage.removeItem(`templateCustomizer-${layout}--${k}`));
                                localStorage.setItem(`templateCustomizer-${layout}--LayoutCollapsed`, "false");
                                if (keepHeader) {
                                    localStorage.setItem(`templateCustomizer-${layout}--HeaderType`, keepHeader);
                                }
                        ...
                        value: function () {
                            ...
                            setTimeout(() => {
                                if (this.settings.navigationLike === "sidenav") {
                                    document.documentElement.classList.remove("layout-navbar-fixed", "layout-navbar-hidden");
                                    if (this.settings.sidenavHeader === "sticky") {
                                        document.documentElement.classList.add("layout-navbar-fixed");
                                    } else if (this.settings.sidenavHeader === "hidden") {
                                        document.documentElement.classList.add("layout-navbar-hidden");
                                    }
                                }
                            }, 1000);
                            //setTimeout(() => {
                            //    const contentArea = document.querySelector(".container-p-y");
                            //    if (contentArea && this.settings.headerType === "fixed") {
                            ...
                            //    const contentArea = document.querySelector(".container-p-y");
                            //    if (contentArea && this.settings.headerType === "fixed") {
                            //        contentArea.style.setProperty("padding-top", "7.25rem", "important");
                            //    }
                            //}, 300);
                            setTimeout(() => {
                                updateContentPadding.call(this);
                            }, 300);
                            ...
                            const updateContentPadding = () => {
                                ...
                                // Apply padding only when header is fixed and not fullscreen
                                if (this.settings.headerType === "fixed" && !isFullscreen) {
                                    paddingTop = "7.25rem";
                                }
                            ...
                            document.addEventListener("fullscreenchange", updateContentPadding);
                            document.addEventListener("webkitfullscreenchange", updateContentPadding);
                            document.addEventListener("msfullscreenchange", updateContentPadding);
                            ...
                            var navLike = this._getSetting("NavigationLike");
                            this.settings.navigationLike = navLike || this.settings.defaultNavigationLike;
                            var sh = this._getSetting("SidenavHeader");
                            this.settings.sidenavHeader = ["static", "sticky", "hidden"].includes(sh) ? sh : this.settings.defaultSidenavHeader;
                        ...
                        value: function () {
                            ...
                            if (i) { i.addEventListener("click", n), this._listeners.push([i, "click", n]); }                            
                            var a = this.container.querySelector(".template-customizer-reset-btn"),
                                s = function () {
                                    t.clearLocalStorage(), window.location.reload()
                                };
                            if (a) { a.addEventListener("click", s), this._listeners.push([a, "click", s]); }                            
                            ...
                            if (this._hasControls("contentLayout headerType layoutCollapsed layoutNavbarOptions rtl", !0)) {
                                ...
                                if (this._hasControls("headerType") && this.settings.navigationLike !== "sidenav") {
                            ...
                            if (this.settings.navigationLike === "sidenav") {
                                const sidenavHeaderWrapper = this._getElementFromString(` <div class="template-customizer-sidenavHeader-wrapper"> <div class="m-0 py-6 pb-6 template-customizer-sidenavHeader w-100"> <label for="customizerSidenavHeader" class="form-label">Sidenav Header</label> <div class="row px-1 template-customizer-sidenavHeader-options"></div> </div> </div>`);
                                const sidenavHeaderOptions = sidenavHeaderWrapper.querySelector(".template-customizer-sidenavHeader-options");
                                this.settings.availableSidenavHeader.forEach(opt => {
                                    const radio = o(opt.name, opt.title, "sidenavHeaderRadios", opt.image);
                                    sidenavHeaderOptions.appendChild(radio);
                                });
                                const current = this.settings.sidenavHeader || this.settings.defaultSidenavHeader;
                                sidenavHeaderOptions.querySelectorAll('input[name="sidenavHeaderRadios"]').forEach(i => i.checked = false);
                                const selectedInput = sidenavHeaderOptions.querySelector(`input[value="${current}"]`);
                                if (selectedInput) selectedInput.checked = true;
                                sidenavHeaderOptions.addEventListener("change", e => {
                                    const val = e.target.value;
                                    t._setSetting("SidenavHeader", val);
                                    document.cookie = 'SidenavHeader=' + val + ';path=/';
                                    document.documentElement.classList.remove("layout-navbar-fixed", "layout-navbar-hidden");
                                    if (val === "sticky") {
                                        document.documentElement.classList.add("layout-navbar-fixed");
                                    } else if (val === "hidden") {
                                ...
                                const navLikeElement = this.container.querySelector(".template-customizer-navigationLike");
                                if (navLikeElement) {
                                    navLikeElement.insertAdjacentElement("afterend", sidenavHeaderWrapper);
                                }
                            }
                            var navLikeWrapper = this.container.querySelector(".template-customizer-navigationLike");
                            if (!navLikeWrapper) {
                                console.error("❌ navigationLike wrapper not found in the DOM");
                                return;
                            }
                            var navLikeOptions = navLikeWrapper.querySelector(".template-customizer-navigationLike-options");
                            if (!navLikeOptions) {
                                console.error("❌ navigationLike-options not found");
                                return;
                            }
                            this.settings.availableNavigationLike.forEach(function (opt) {
                                var radio = o(opt.name, opt.title, "navigationLikeRadios", opt.image);
                                navLikeOptions.appendChild(radio);
                            });
                            var currentNavLike = this.settings.navigationLike || this.settings.defaultNavigationLike;
                            var allNavInputs = navLikeOptions.querySelectorAll('input[name="navigationLikeRadios"]');
                            allNavInputs.forEach(input => input.checked = false);
                            var selectedInput = navLikeOptions.querySelector('input[value="' + currentNavLike + '"]');
                            if (selectedInput) selectedInput.checked = true;
                            navLikeOptions.addEventListener("change", function (e) {
                                const selectedNav = e.target.value;
                                t.settings.navigationLike = selectedNav;
                                if (selectedNav === "sidenav") {
                                    const headerStaticInput = document.querySelector('input[name="headerRadioIcon"][value="static"]');
                                    if (headerStaticInput) {
                                        headerStaticInput.checked = true;
                                    }
                                    t.settings.headerType = "static";
                                    t._setSetting("HeaderType", "static");
                                    localStorage.setItem("templateCustomizer-" + t._getLayoutName() + "--HeaderType", "static");
                                    console.log("📌 sidenav selected,forced headerType to static");
                                } else {
                                    console.log("🧭 navigationLike changed to:", selectedNav);
                                }
                            });
                            setTimeout((function () {
                            ...
                            })) : e.appendChild(this.container); setTimeout(function () {
                                ...
                                if (resetBtn) {
                                    resetBtn.addEventListener("click", function () {
                                        Swal.fire({
                                            ...
                                            text: 'This will remove all saved UI settings and restore defaults.',
                                            icon: 'warning',
                                            ...
                                            if (result.isConfirmed) {
                                                const layouts = ["horizontal-menu-template", "vertical-menu-template", "sneat", "plate"];
                                                layouts.forEach(name => {
                                                    Object.keys(localStorage).forEach(key => {
                                                        if (key.startsWith(`templateCustomizer-${name}--`) || key.startsWith(`${name}--`)) {
                                                            localStorage.removeItem(key);
                                                        }
                                                    });
                                                });
                                                document.cookie = 'NavigationLike=; path=/; max-age=0';
                                                localStorage.removeItem('uiSettingsReloadedOnce');
                                                localStorage.removeItem('aca360_ui_settings'); // ← Clear cache on reset
                                                Swal.fire({
                                                    icon: 'success',
                                                    title: 'Reset!',
                                ...
                                const trackableElements = document.querySelectorAll('input[type="radio"],input[type="checkbox"]');
                                trackableElements.forEach(el => {
                                    el.dataset.defaultChecked = el.checked;
                                });
                                const resetCustomizerChanges = () => {
                                    trackableElements.forEach(el => {
                                ...
                                if (saveBtn) {
                                    saveBtn.addEventListener("click", function () {
                                        const settings = {
                                            Theme: getCheckedValue("customRadioIcon") || "light",
                                            Skin: getCheckedValue("skinRadios") || "default",
                                            HeaderType: getCheckedValue("headerRadioIcon") || "static",
                                            NavigationLike: getCheckedValue("navigationLikeRadios") || (layoutName.includes("horizontal") ? "topnav" : "sidenav"),
                                            PrimaryColor:
                                                document.querySelector('input[name="colorRadioIcon"]:checked')?.dataset.color ||
                                                localStorage.getItem(`templateCustomizer-${layoutName}--Color`) || "#696cff",
                                            SidenavHeader: getCheckedValue("sidenavHeaderRadios") || "static",
                                            SemiDark: document.querySelector(".template-customizer-semi-dark-switch")?.checked || false,
                                            IsCollapsed: getCheckedValue("layoutsRadios") === "collapsed",
                                            Rtl: getCheckedValue("directionRadioIcon") === "rtl",
                                            ContentLayout: getCheckedValue("contentRadioIcon") || "compact",
                                        };

                                        // Sync settings
                                        localStorage.setItem(`templateCustomizer-${layoutName}--NavigationLike`, settings.NavigationLike);
                                        localStorage.setItem(`templateCustomizer-${layoutName}--SidenavHeader`, settings.SidenavHeader);
                                        document.cookie = `NavigationLike=${settings.NavigationLike}; path=/; max-age=31536000`;
                                        ...
                                        fetch("/UISettings/Save", {
                                            ...
                                            if (res.ok) {
                                                Swal.fire({
                                                    ...
                                                    localStorage.removeItem('uiSettingsReloadedOnce');
                                                    localStorage.removeItem('aca360_ui_settings'); // ← Clear cache so next load re-fetches from DB
                                                    window.location.reload();
                                                });
                                            } else {
                                            ...
                                            Swal.fire({ icon: 'error', title: 'Error', text: 'Network or server error occurred.' });
                                        });
                                    });
                                }
