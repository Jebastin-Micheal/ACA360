document.addEventListener("DOMContentLoaded", function (e) {
    ...
    t && new DataTable(t, {
        ...
        columnDefs: [{
            ...
            targets: 2,
            render: function (e, t, a, s) {
                return '<span class="text-nowrap text-heading">' + a.name + "</span>"
            }
        }, {
            targets: 3,
            orderable: !1,
        ...
        [{
            ...
            selector: ".dt-length",
            classToAdd: "mb-0 mb-md-5"
        }, {
            selector: ".dt-length .form-select",
            classToRemove: "form-select-sm"
        }, {
            selector: ".dt-buttons",
            classToAdd: "mb-0 w-auto"
        }, {
            selector: ".dt-layout-start",
            classToAdd: "mt-0 px-5"
        }, {
