document.addEventListener("DOMContentLoaded", function () {
    {
        ...
        let a = {
            ...
            e = (r(a.emailList), r(a.emailFilters), r(a.emailView), (r = (e, t) => {
                e && new Quill(e, {
                    modules: {
                        toolbar: t
                    },
            ...
            })(a.emailEditor, ".email-editor-toolbar"), r(a.emailReplyEditor, ".email-reply-toolbar"), a.bookmarkEmail.forEach(e => {
                e.addEventListener("click", e => {
                    var t = e.currentTarget.closest(".email-list-item");
                    e.stopPropagation(), t.hasAttribute("data-starred") ? t.removeAttribute("data-starred") : t.setAttribute("data-starred", "true")
                })
                ...
                e.addEventListener("click", e => {
                    ...
                    a.selectAllEmails.indeterminate = 0 < e && e < t, a.selectAllEmails.checked = e === t
                })
            }), a.emailSearch && a.emailSearch.addEventListener("keyup", e => {
                let l = e.currentTarget.value.toLowerCase();
                e = document.querySelector(".email-filter-folders .active"), e = e ? e.getAttribute("data-target") : "inbox";
                ("inbox" !== e ? Array.from(document.querySelectorAll(`.email-list-item[data-${e}="true"]`)) : a.emailListItems).forEach(e => {
                    ...
                    e.classList.toggle("d-block", t.includes(l)), e.classList.toggle("d-none", !t.includes(l))
                })
            }), a.emailFilterByFolders.forEach(e => {
                e.addEventListener("click", e => {
                    let l = e.currentTarget.getAttribute("data-target");
                    a.appEmailSidebar.classList.remove("show"), a.appOverlay.classList.remove("show"), a.emailFilterByFolders.forEach(e => e.classList.remove("active")), e.currentTarget.classList.add("active"), a.emailListItems.forEach(e => {
                        var t = "inbox" === l || e.hasAttribute("data-" + l);
                        e.classList.toggle("d-block", t), e.classList.toggle("d-none", !t)
                    })
                })
            }), e => {
                document.querySelector(e).classList.toggle("d-block"), document.querySelector(e).classList.toggle("d-none")
            });
        if (a.toggleBCC && a.toggleBCC.addEventListener("click", () => e(".email-compose-bcc")), a.toggleCC && a.toggleCC.addEventListener("click", () => e(".email-compose-cc")), a.emailCompose.addEventListener("hidden.bs.modal", () => {
            document.querySelector(".email-editor .ql-editor").innerHTML = "", document.getElementById("emailContacts").value = "", s()
        }), a.emailListDelete && a.emailListDelete.addEventListener("click", () => {
            a.emailListItemInputs.forEach(e => {
                e.checked && e.closest("li.email-list-item").remove()
            }), a.selectAllEmails.indeterminate = !1, a.selectAllEmails.checked = !1, 0 === a.emailListItems.length && a.emailListEmpty.classList.remove("d-none")
        }), a.emailListRead && a.emailListRead.addEventListener("click", () => {
            a.emailListItemInputs.forEach(e => {
                e.checked && (e.checked = !1, (e = e.closest("li.email-list-item")).classList.add("email-marked-read"), (e = e.querySelector(".email-list-item-actions li")).classList.replace("email-read", "email-unread"), e.querySelector("i").classList.replace("bx-envelope-open", "bx-envelope"))
            }), a.selectAllEmails.indeterminate = !1, a.selectAllEmails.checked = !1
            ...
            a.refreshEmails.addEventListener("click", () => {
                ...
                var e = document.createElement("div"),
                    t = (e.classList.add("spinner-border", "text-primary"), e.setAttribute("role", "status"), document.querySelector(".email-list .notiflix-block"));
                t && t.appendChild(e), setTimeout(() => {
                    i.settings.suppressScrollY = !1, Block.remove(l)
                }, 1e3), i.settings.suppressScrollY = !0
            })
        }
        let l = document.querySelector(".email-earlier-msgs"),
            t = (l && l.addEventListener("click", () => {
                ...
                e && e.classList.add("hide-pseudo"), t && (t.style.display = "none" !== t.style.display && t.style.display ? "none" : "block", t.classList.toggle("slide-toggle")), l.remove()
            }), $("#emailContacts"));
        ...
        (r = i ? i.querySelector(".scroll-to-reply") : null) && i && r.addEventListener("click", () => {
            ...
            l.addEventListener("click", e => {
                ...
                l.classList.contains("email-delete") ? (e.remove(), document.querySelectorAll(".email-list-item").length || a.emailListEmpty.classList.remove("d-none")) : (l.classList.contains("email-read") || l.classList.contains("email-unread")) && (t = l.querySelector("i"), e.classList.toggle("email-marked-read", l.classList.contains("email-read")), l.classList.toggle("email-read"), l.classList.toggle("email-unread"), t.classList.toggle("bx-envelope-open"), t.classList.toggle("bx-envelope"))
            })
        })
    }
});